...
class NetworkTest < ActiveSupport::TestCase
  ...
  test 'should not save network with an invalid :android_app_url' do
    network =
      Network.new(android_app_url: 'https://an-invalid-anroid-app-url.com')
  ...
  test 'should validate network with an valid :android_app_url' do
    network =
      Network.new(
        android_app_url:
          'https://play.google.com/store/apps/details?id=com.ubitricity'
      )
  ...
  test 'should convert blank :android_app_url to nil' do
    ...
    assert_nil network.android_app_url
    assert_not_includes network.errors.keys, :android_app_url
  end
  ...
  test 'should convert blank :ios_app_url to nil' do
    ...
    assert_nil network.ios_app_url
    assert_not_includes network.errors.keys, :ios_app_url
  end
end
